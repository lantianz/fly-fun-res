package com.ltz.flyfun.parser.parserService;
...
public interface ParserInterface {
    ...
    default String getDefaultDomain() {
        return SourceEnum.getDomainUrlBySource(getSource());
    }
...
//    }
     ...
     * <p>将在 {link com.ltz.flyfun.view.HomeFragment}中跳转
     * {link com.ltz.flyfun.view.ClassificationVodListActivity}时初始化数组，确保长度避免使用时出现下标越界</p>
     * @return
     */
...
//    }
     ...
     * @return {@link VodDataBean}
     */
    VodDataBean parserTopicList(String source);
     ...
     */
//    @LayoutRes
//    default int setTopicListItemType() {
...
//    }
     ...
     * @return {@link VodDataBean}
     */
    VodDataBean parserTopicVodList(String source);
     ...
     * @return
     */
    String getTopicUrl(String url, int page);
     ...
     * @return 返回不能为0！！！ 需自己实现 平板、手机横竖屏显示数量
     */
    default int setTopicItemListItemSize(boolean isPad, boolean isPortrait) {
