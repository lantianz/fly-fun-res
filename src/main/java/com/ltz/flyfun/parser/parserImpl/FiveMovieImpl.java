package com.ltz.flyfun.parser.parserImpl;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.ltz.flyfun.parser.LogUtil;
import com.ltz.flyfun.parser.bean.*;
...
//    }
    ...
    public List<MainDataBean> parserMainData(String source) {
        try {
            ...
            tags.add(new MainDataBean.Tag(HomeTagEnum.NETFLIX.name, HomeTagEnum.NETFLIX.content));
            tags.add(new MainDataBean.Tag(HomeTagEnum.DY.name, HomeTagEnum.DY.content));
            tags.add(new MainDataBean.Tag(HomeTagEnum.DSJ.name, HomeTagEnum.DSJ.content));
            tags.add(new MainDataBean.Tag(HomeTagEnum.FL.name, HomeTagEnum.FL.content));
            tags.add(new MainDataBean.Tag(HomeTagEnum.DM.name, HomeTagEnum.DM.content));
            tags.add(new MainDataBean.Tag(HomeTagEnum.ZYJL.name, HomeTagEnum.ZYJL.content));
            tags.add(new MainDataBean.Tag(HomeTagEnum.JRGX.name, HomeTagEnum.JRGX.content));
            tags.add(new MainDataBean.Tag(HomeTagEnum.ZT.name, HomeTagEnum.ZT.content));
            tags.add(new MainDataBean.Tag(HomeTagEnum.PHB.name, HomeTagEnum.PHB.content));
...
//                            contentBean.setOpenMoreClass(TopicListActivity.class);
...
//            String pageTitle = document.getElementsByTag("title").text();
     ...
     */
    @Override
    public VodDataBean parserTopicList(String source) {
        try {
            VodDataBean vodDataBean = new VodDataBean();
            List<VodDataBean.Item> items = new ArrayList<>();
            Document document = Jsoup.parse(source);
     ...
     */
//    @Override
//    public int setTopicListItemType() {
//        return ParserInterface.super.setTopicListItemType();
//    }
     ...
     */
    @Override
    public VodDataBean parserTopicVodList(String source) {
     ...
     */
    @Override
    public String getTopicUrl(String url, int page) {
        LogUtil.logInfo("getTopicUrl", getDefaultDomain() + String.format(url, page));
        return getDefaultDomain() + String.format(url, page);
    }
     ...
     */
    @Override
    public int setTopicItemListItemSize(boolean isPad, boolean isPortrait) {
        return ParserInterface.super.setTopicItemListItemSize(isPad, isPortrait);
    }
